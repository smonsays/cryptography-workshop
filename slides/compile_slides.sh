...
pandoc -t revealjs -s -o ${FILENAME}.html ${FILENAME}.md --slide-level 2 -V revealjs-url=./reveal.js -V theme=robolung -V slideNumber=true -V hash=true -V history=true -V margin=0.1 -V preloadIframes=true -V controlsTutorial=false --mathjax -V controls=true
